...
- Add the [.eslintrc](https://github.com/codefellows-seattle-301d4/01-mobile-first/blob/master/.eslintrc) config file to the root of your repo, so we are all on using the same linter settings.
